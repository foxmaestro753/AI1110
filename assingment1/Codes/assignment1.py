...
answer2 = (math.comb(black,1))*(math.comb(red,1))
answer3 = (math.comb(red,1))*(math.comb(black,1)) + (math.comb(black,1))*(math.comb(red,1))

count = (math.comb(ball,1))*(math.comb(ball,1))

print(f"Question 1 answer = {Fraction(answer1,count)}\nQuestion 2 answer = {Fraction(answer2,count)}\nQuestion 3 answer = {Fraction(answer3,count)}\n")
