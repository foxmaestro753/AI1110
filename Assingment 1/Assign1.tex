...
Therefore, Probability of getting one of them is black and other is red: = Probability of getting first ball is black and second is red + Probability of getting first
ball is red and second is black
= $\frac{5}{9} \times\frac{4}{9}=\frac{20}{81}$
\end{enumerate}
\section{Code}
The python code is as follows : 
\lstinputlisting[language=Python]{assingment1.py}
\end{document}