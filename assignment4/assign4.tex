...
\section{Answer}
Let X be the random variable representing the number of successful outcomes in n = 1 trial, and let p be the probability of success for each trial. Since there are 8 possible outcomes and they are equally likely, we have p = 1/8 and X = 1 everywhere as only one trial was allowed

\begin{enumerate}
\item \pr{8} : 
\begin{align}
\pr{X=1} &= \comb{1}{1}\brak{\frac{1}{8}}^1\brak{\frac{7}{8}}^0\\
&= \frac{1}{8}
\end{align}
\item \pr{\text{Odd numbers}} : 
\begin{align}
\pr{X=1} &= \comb{1}{1}\brak{\frac{4}{8}}^1\brak{\frac{4}{8}}^0\\
&= \frac{4}{8}
\end{align}
\item \pr{\text{Number}>2} : 
\begin{align}
\pr{X=1} &= \comb{1}{1}\brak{\frac{6}{8}}^1\brak{\frac{2}{8}}^0\\
&= \frac{3}{4}
\end{align}
\item \pr{\text{Number}<9} : 
\begin{align}
\pr{X=1} &= \comb{1}{1}\brak{\frac{8}{8}}^1\brak{\frac{0}{8}}^0\\
&= \frac{8}{8} = 1
\end{align}
\end{enumerate}
\end{document}